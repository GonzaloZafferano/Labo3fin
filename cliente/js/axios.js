...
function insertarElementoAXIOSconPromesa (url, nuevoElemento){  
...
function eliminarElementoPorIdAXIOSconPromesa (url, id){
    return new Promise((resolve, reject) =>{
        axios.delete(url + "/" + id)
        .then((rta)=>{          
            resolve(rta);
...
export {actualizarElementoAXIOS, 
        ...
        eliminarElementoPorIdAXIOSconPromesa,
        insertarElementoAXIOSconPromesa};
